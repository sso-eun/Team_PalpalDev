// app/src/main/java/com/example/dundun_hi/ui/guardian/GuardianViewModel.kt

package com.example.dundun_hi.ui.guardian
...
class GuardianViewModel(
    ...
    fun fetchGuardianFromServer() {
        ...
        viewModelScope.launch {
            try {
                val certList = RetrofitClient.memberService.getCertList()
