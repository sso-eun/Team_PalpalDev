...
[ DOWNLOAD for Android ](https://drive.google.com/file/d/1mXfbsTxRwoEGrVf1TNMbqNweMmf_d3Ak/view?usp=sharing)
...
- 전화, 카메라, 지도 등 실생활에 필요한 주요 메뉴 배치
- 어려운 영어가 아닌, 쉽고 큰 한글 단어 위주의 설계 
- 모든 과정에서의 최소한의 절차로 진행 

#### 2. 실생활에 유용한 기능 제공 

 - 인근 병원, 무더위 쉼터, 경로당 길 안내

#### 3. 스케줄 관리 기능

 - 외출/귀가 시 보호자 알림 기능 제공 
 - 일정 등록 후 일정 알림으로 스케줄 관리 가능 

#### 4. 멀리 떨어져 있어도 가족의 연결 

- 가족과의 사진 전송으로 간단한 일상 공유
- 안전 및 위험 상황에서 긴급 전화 바로 연결 기능 

#### 5. 시스템 구조 
![스크린샷 2025-06-18 225756](https://github.com/user-attachments/assets/e06d7341-930f-422f-b30b-ef8f1442432c)
![스크린샷 2025-06-18 225859](https://github.com/user-attachments/assets/131a6d73-0c40-4a78-a74b-2415948daba1)
...
4. 개발 문서 양식에 수식이 포함된 경우가 있습니다. 이 때 수식을 지우지 말고, 그대로 사용해 주세요. 결정된 양식은 수정되어서는 안됩니다. 
